...
exec(compile(open('parse_Drugbank.py', "rb").read(), 'parse_Drugbank.py', 'exec'), globals())
...
def parse_organoid_ssGSEA_NES(cancer_type, pathway_source):
	...
	if cancer_type.lower() == 'coad':
		exec(compile(open('parse_COAD_ssGSEA.py', "rb").read(), 'parse_COAD_ssGSEA.py', 'exec'), globals())
...
def parse_coad_organoid_transcriptome():
	...
	exec(compile(open('parse_COAD_organoid_data.py', "rb").read(), 'parse_COAD_organoid_data.py', 'exec'), globals())
